...
function ReminderTableHead() {
  return (
    <div className="table-head">
      ...
      <span className="table-col status">Admin status</span>
      <span className="table-col status">Account Status</span>
    </div>
  );
}

export default ReminderTableHead;
